...
#> age   -0.001  0.012  -0.102   0.919    
#> sex    1.522  0.440   3.456   0.001 ***
#> ---
...
#> AFTGEE Estimator
#>             Estimate StdErr z.value p.value    
#> (Intercept)    2.071  0.831   2.491   0.013 *  
#> age           -0.005  0.009  -0.569   0.569    
#> sex            1.374  0.411   3.347   0.001 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
