...
The method is rarely used in practice due to numerical challenges. 
...
@chiou2014marginal embedded the generalized estimating equation (GEE) procedure to generalized the iterative procedure to 
